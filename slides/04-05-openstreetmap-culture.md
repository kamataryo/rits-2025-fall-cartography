...
3. **OpenStreetMapについて** (25分)
4. **OSMアカウント作成と編集体験** (45分)

### 第5回（後半95分）
1. **OSMアカウント作成と編集体験** (20分)
1. **OSMデータの構造を実際に見てみる** (20分)
2. **Overpass Turboでデータ探索** (30分)
3. **データ品質と活用方法** (20分)
4. **課題説明** (5分)
...
少なくとも 5箇所の追加/編集を行い、編集が完了していることを確認する。
-> 編集した箇所を次回の授業までに提出
