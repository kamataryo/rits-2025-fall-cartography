...
// TODO: すぐに、良いデータを追加してもらうのは難しいので、解説に止める

### POI（Point of Interest）の追加

#### 目標

大学周辺または馴染みのある場所について、データを追加してみる。
...
OSM にデータを登録するための現地調査

- 家の周り
- 大学の周辺
- その他馴染みのある地域

1. OSM に掲載されていない POI や POI のデータを少なくとも1つ見つけてみる。
